...
def main():
	...
	prokka_exe = "/home/fsepulveda/Documents/PROGRAMS/prokka-1.12/bin/prokka"
	core_database = "/home/fsepulveda/Desktop/ccr_database/database/core_db"

	sccmec_file = sys.argv[1]
	sccmec_id = sccmec_file.split(".")[0]

	execute_prokka(prokka_exe, sccmec_id, sccmec_file)
	ffn, gff, fna, faa, gbk = prokka_files(sccmec_id)
	...
	for k in ordered_keys:
		...
		match = simpleBlastParser(results)
